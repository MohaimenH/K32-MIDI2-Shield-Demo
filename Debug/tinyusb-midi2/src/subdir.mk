...
C_SRCS += \
../tinyusb-midi2/src/tusb.c 

C_DEPS += \
./tinyusb-midi2/src/tusb.d 

OBJS += \
./tinyusb-midi2/src/tusb.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/%.o: ../tinyusb-midi2/src/%.c tinyusb-midi2/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src

clean-tinyusb-2d-midi2-2f-src:
	-$(RM) ./tinyusb-midi2/src/tusb.d ./tinyusb-midi2/src/tusb.o

.PHONY: clean-tinyusb-2d-midi2-2f-src
