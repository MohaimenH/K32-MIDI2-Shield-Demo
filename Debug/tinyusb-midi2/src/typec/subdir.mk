...
C_DEPS += \
./tinyusb-midi2/src/typec/usbc.d 

OBJS += \
./tinyusb-midi2/src/typec/usbc.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/typec/%.o: ../tinyusb-midi2/src/typec/%.c tinyusb-midi2/src/typec/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-typec

clean-tinyusb-2d-midi2-2f-src-2f-typec:
	-$(RM) ./tinyusb-midi2/src/typec/usbc.d ./tinyusb-midi2/src/typec/usbc.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-typec
