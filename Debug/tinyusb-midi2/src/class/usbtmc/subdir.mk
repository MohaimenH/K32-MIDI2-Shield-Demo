...
C_SRCS += \
../tinyusb-midi2/src/class/usbtmc/usbtmc_device.c 

C_DEPS += \
./tinyusb-midi2/src/class/usbtmc/usbtmc_device.d 

OBJS += \
./tinyusb-midi2/src/class/usbtmc/usbtmc_device.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/class/usbtmc/%.o: ../tinyusb-midi2/src/class/usbtmc/%.c tinyusb-midi2/src/class/usbtmc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-usbtmc

clean-tinyusb-2d-midi2-2f-src-2f-class-2f-usbtmc:
	-$(RM) ./tinyusb-midi2/src/class/usbtmc/usbtmc_device.d ./tinyusb-midi2/src/class/usbtmc/usbtmc_device.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-usbtmc
