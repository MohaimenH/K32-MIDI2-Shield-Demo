...
C_SRCS += \
../tinyusb-midi2/src/class/midi/midi_device.c 

C_DEPS += \
./tinyusb-midi2/src/class/midi/midi_device.d 

OBJS += \
./tinyusb-midi2/src/class/midi/midi_device.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/class/midi/%.o: ../tinyusb-midi2/src/class/midi/%.c tinyusb-midi2/src/class/midi/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-midi

clean-tinyusb-2d-midi2-2f-src-2f-class-2f-midi:
	-$(RM) ./tinyusb-midi2/src/class/midi/midi_device.d ./tinyusb-midi2/src/class/midi/midi_device.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-midi
