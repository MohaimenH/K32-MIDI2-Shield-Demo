...
C_SRCS += \
../tinyusb-midi2/src/class/hid/hid_device.c \
../tinyusb-midi2/src/class/hid/hid_host.c 

C_DEPS += \
./tinyusb-midi2/src/class/hid/hid_device.d \
./tinyusb-midi2/src/class/hid/hid_host.d 

OBJS += \
./tinyusb-midi2/src/class/hid/hid_device.o \
./tinyusb-midi2/src/class/hid/hid_host.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/class/hid/%.o: ../tinyusb-midi2/src/class/hid/%.c tinyusb-midi2/src/class/hid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-hid

clean-tinyusb-2d-midi2-2f-src-2f-class-2f-hid:
	-$(RM) ./tinyusb-midi2/src/class/hid/hid_device.d ./tinyusb-midi2/src/class/hid/hid_device.o ./tinyusb-midi2/src/class/hid/hid_host.d ./tinyusb-midi2/src/class/hid/hid_host.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-hid
