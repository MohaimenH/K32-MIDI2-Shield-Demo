...
C_SRCS += \
../tinyusb-midi2/src/class/net/ecm_rndis_device.c \
../tinyusb-midi2/src/class/net/ncm_device.c 

C_DEPS += \
./tinyusb-midi2/src/class/net/ecm_rndis_device.d \
./tinyusb-midi2/src/class/net/ncm_device.d 

OBJS += \
./tinyusb-midi2/src/class/net/ecm_rndis_device.o \
./tinyusb-midi2/src/class/net/ncm_device.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/class/net/%.o: ../tinyusb-midi2/src/class/net/%.c tinyusb-midi2/src/class/net/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-net

clean-tinyusb-2d-midi2-2f-src-2f-class-2f-net:
	-$(RM) ./tinyusb-midi2/src/class/net/ecm_rndis_device.d ./tinyusb-midi2/src/class/net/ecm_rndis_device.o ./tinyusb-midi2/src/class/net/ncm_device.d ./tinyusb-midi2/src/class/net/ncm_device.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-net
