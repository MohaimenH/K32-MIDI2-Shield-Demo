...
tinyusb-midi2/src/class/audio/%.o: ../tinyusb-midi2/src/class/audio/%.c tinyusb-midi2/src/class/audio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-audio

clean-tinyusb-2d-midi2-2f-src-2f-class-2f-audio:
	-$(RM) ./tinyusb-midi2/src/class/audio/audio_device.d ./tinyusb-midi2/src/class/audio/audio_device.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-class-2f-audio
