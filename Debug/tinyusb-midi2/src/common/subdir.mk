...
C_SRCS += \
../tinyusb-midi2/src/common/tusb_fifo.c 

C_DEPS += \
./tinyusb-midi2/src/common/tusb_fifo.d 

OBJS += \
./tinyusb-midi2/src/common/tusb_fifo.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/common/%.o: ../tinyusb-midi2/src/common/%.c tinyusb-midi2/src/common/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-common

clean-tinyusb-2d-midi2-2f-src-2f-common:
	-$(RM) ./tinyusb-midi2/src/common/tusb_fifo.d ./tinyusb-midi2/src/common/tusb_fifo.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-common
