...
../tinyusb-midi2/src/device/usbd_control.c 

C_DEPS += \
./tinyusb-midi2/src/device/usbd.d \
./tinyusb-midi2/src/device/usbd_control.d 

OBJS += \
./tinyusb-midi2/src/device/usbd.o \
./tinyusb-midi2/src/device/usbd_control.o 


# Each subdirectory must supply rules for building sources it contributes
tinyusb-midi2/src/device/%.o: ../tinyusb-midi2/src/device/%.c tinyusb-midi2/src/device/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-tinyusb-2d-midi2-2f-src-2f-device

clean-tinyusb-2d-midi2-2f-src-2f-device:
	-$(RM) ./tinyusb-midi2/src/device/usbd.d ./tinyusb-midi2/src/device/usbd.o ./tinyusb-midi2/src/device/usbd_control.d ./tinyusb-midi2/src/device/usbd_control.o

.PHONY: clean-tinyusb-2d-midi2-2f-src-2f-device
